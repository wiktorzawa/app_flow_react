...
import { Checkbox, Label, Progress, Table, TableBody, TableCell, TableRow } from "flowbite-react";
          ...
          <div className="overflow-hidden shadow">
            <Table className="min-w-full divide-y divide-gray-200">
              <TableBody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                <TableRow className="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
                  ...
                  <TableCell className="relative flex items-center space-x-4 whitespace-nowrap p-4">
                  ...
                  <TableCell className="max-w-sm overflow-hidden truncate p-4 text-base font-semibold text-gray-900 dark:text-white xl:max-w-screen-md 2xl:max-w-screen-lg">
                ...
                <TableRow className="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
                  ...
                  <TableCell className="max-w-sm overflow-hidden truncate p-4 text-base font-normal text-gray-700 dark:text-gray-400 xl:max-w-screen-md 2xl:max-w-screen-lg">
                  ...
                  <TableCell className="whitespace-nowrap p-4 text-base font-normal text-gray-700 dark:text-gray-400">
