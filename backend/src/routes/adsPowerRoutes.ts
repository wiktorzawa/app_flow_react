...
router.post(
  ...
  asyncHandler(adsPowerController.clearAllAdsPowerProfilesCache)
);
router.get(
  '/profiles/:userId/start-browser',
  asyncHandler(adsPowerController.startAdsPowerBrowser)
);
...
router.get(
  ...
  asyncHandler(adsPowerController.checkAdsPowerBrowserStatus)
);
