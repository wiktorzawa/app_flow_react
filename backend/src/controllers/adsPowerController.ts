...
const CreateProfilePayloadSchema = z
  .object({
    ...
    repeat_config: z
      .array(z.union([z.literal(0), z.literal(2), z.literal(3), z.literal(4)]))
      .optional(),
  })
  .strict();
...
const DeleteProfilesBodySchema = z
  .object({
    user_ids: z
      .array(z.string().min(1, 'User ID in array cannot be empty'))
...
export class AdsPowerController {
  ...
  public checkAdsPowerApi = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const apiResponse: AdsPowerResponse<AdsPowerGroupListData> | null =
      await adsPowerService.checkApiStatus();
  ...
  public listAdsPowerProfiles = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<AdsPowerProfileListData> | null =
      await adsPowerService.listProfiles(page, pageSize);
   ...
   */
  public updateAdsPowerProfile = asyncHandler(
   ...
   */
  public deleteAdsPowerProfiles = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      if (apiResponse && apiResponse.code === 0) {
        ...
        res.status(apiResponse?.code === -1 || !apiResponse ? 500 : 400).json({
          success: false,
          message:
            apiResponse?.msg || 'Failed to delete AdsPower profiles or API returned an error.',
          errorDetails: apiResponse || null,
        });
      }
    }
   ...
   */
  public regroupAdsPowerProfiles = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      if (apiResponse && apiResponse.code === 0) {
        ...
        res.status(apiResponse?.code === -1 || !apiResponse ? 500 : 400).json({
          success: false,
          message:
            apiResponse?.msg || 'Failed to regroup AdsPower profiles or API returned an error.',
          errorDetails: apiResponse || null,
        });
      }
    }
   ...
   */
  public clearAllAdsPowerProfilesCache = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      if (apiResponse && apiResponse.code === 0) {
        ...
        const statusCode =
          apiResponse?.code === -1
            ? 409
            : apiResponse?.code !== 0 && apiResponse !== null
              ? 400
              : 500;
  ...
  public startAdsPowerBrowser = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<StartBrowserResponseData> | null =
      await adsPowerService.startBrowser(
        userId,
        launch_args,
        ip_tab,
        open_tabs,
  ...
  public stopAdsPowerBrowser = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<StopBrowserResponseData> | null =
      await adsPowerService.stopBrowser(userId);
   ...
   */
  public checkAdsPowerBrowserStatus = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
      if (!paramsValidationResult.success) {
        res.status(400).json({
  ...
  public listAdsPowerGroups = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<AdsPowerGroupListData> | null =
      await adsPowerService.listGroups(page, page_size);
  ...
  public updateAdsPowerGroup = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<UpdateGroupResponseData> | null =
      await adsPowerService.updateGroup(payload);
  ...
  public deleteAdsPowerGroups = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const apiResponse: AdsPowerResponse<DeleteGroupsResponseData> | null =
      await adsPowerService.deleteGroups(payload);
   ...
   */
  public getAdsPowerProfileDetail = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
      if (!paramsValidationResult.success) {
        res.status(400).json({
