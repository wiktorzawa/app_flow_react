...
interface BrowserStartParams {
  user_id: string;
  launch_args?: string;
  ip_tab?: '0' | '1';
  open_tabs?: '0' | '1';
  clear_cache_after_closing?: '0' | '1';
}
...
class AdsPowerService {
  ...
  public async checkApiStatus(): Promise<AdsPowerResponse<AdsPowerGroupListData> | null> {
    try {
      console.log(
        `Attempting to connect to AdsPower API at ${ADS_POWER_API_URL}/api/v1/group/list`
      );
      const response = await this.apiClient.get<AdsPowerResponse<AdsPowerGroupListData>>(
        '/api/v1/group/list',
        {
          params: {
      ...
      console.log(
        'AdsPower API response data (Query Group):',
      ...
      if (axios.isAxiosError(error)) {
        ...
        if (error.response) {
          ...
          console.error(
            'AdsPower API error response headers:',
            JSON.stringify(error.response.headers, null, 2)
          );
          console.error(
            'AdsPower API error response data:',
        ...
        console.error(
          'An unexpected error occurred while connecting to AdsPower API (checkApiStatus):',
          error
        );
      }
      return null;
  ...
  public async createProfile(
    ...
    try {
      ...
      console.log(
        'Attempting to create AdsPower profile with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<CreateProfileResponseData>>(
        endpoint,
        payload
      );
      console.log(
        'AdsPower create profile API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      console.error(
        'Request payload for failed profile creation:',
        JSON.stringify(payload, null, 2)
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (createProfile):',
        ...
        console.error(
          'AdsPower API no response received (createProfile). Request details:',
          axiosError.request
        );
      } else {
  ...
  public async listProfiles(
    ...
    try {
      ...
      const response = await this.apiClient.get<AdsPowerResponse<AdsPowerProfileListData>>(
        endpoint,
        {
          params: {
      ...
      console.log(
        'AdsPower list profiles API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (listProfiles):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (listProfiles). Request details:',
          axiosError.request
        );
      } else {
  ...
  public async updateProfile(
    ...
    try {
      ...
      console.log(
        'Attempting to update AdsPower profile with payload:',
        JSON.stringify(payload, null, 2)
      );
      // W AdsPower API, user_id jest częścią payloadu dla aktualizacji
      const response = await this.apiClient.post<AdsPowerResponse<UpdateProfileResponseData>>(
        endpoint,
        payload
      );
      console.log(
        'AdsPower update profile API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      const axiosError = error as AxiosError;
      console.error(
        `Error updating AdsPower profile (user_id: ${payload.user_id}). Message: ${axiosError.message}`
      );
      console.error('Request payload for failed profile update:', JSON.stringify(payload, null, 2));
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (updateProfile):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (updateProfile). Request details:',
          axiosError.request
        );
      } else {
  ...
  public async deleteProfiles(
    ...
    try {
      ...
      console.log(
        'Attempting to delete AdsPower profiles with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<DeleteProfilesResponseData>>(
        endpoint,
        payload
      );
      console.log(
        'AdsPower delete profiles API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      console.error(
        'Request payload for failed profile deletion:',
        JSON.stringify(payload, null, 2)
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (deleteProfiles):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (deleteProfiles). Request details:',
          axiosError.request
        );
      } else {
        console.error(
          'Error setting up AdsPower API request (deleteProfiles):',
          axiosError.message
        );
      }
      return null;
  ...
  public async regroupProfiles(
    ...
    try {
      ...
      console.log(
        'Attempting to regroup AdsPower profiles with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<RegroupProfilesResponseData>>(
        endpoint,
        payload
      );
      console.log(
        'AdsPower regroup profiles API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      console.error(
        'Request payload for failed profile regrouping:',
        JSON.stringify(payload, null, 2)
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (regroupProfiles):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (regroupProfiles). Request details:',
          axiosError.request
        );
      } else {
        console.error(
          'Error setting up AdsPower API request (regroupProfiles):',
          axiosError.message
        );
      }
      return null;
  ...
  public async clearAllProfilesCache(): Promise<AdsPowerResponse<ClearAllProfilesCacheResponseData> | null> {
    ...
    try {
      ...
      const response = await this.apiClient.post<
        AdsPowerResponse<ClearAllProfilesCacheResponseData>
      >(endpoint, {});
      console.log(
        'AdsPower clear all profiles cache API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (clearAllProfilesCache):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'Error setting up AdsPower API request (clearAllProfilesCache):',
          axiosError.message
        );
      }
      return null;
  ...
  public async startBrowser(
    ...
    const params: BrowserStartParams = { user_id: userId };

    if (launchArgs && launchArgs.length > 0) {
      params.launch_args = JSON.stringify(launchArgs);
    }
    if (ipTab) {
      params.ip_tab = ipTab;
    }
    ...
    try {
      console.log(
        `Attempting to start AdsPower browser for profile ID: ${userId} at URL: ${fullUrl}`
      );
      console.log('With params:', JSON.stringify(params));
      const response = await this.apiClient.get<AdsPowerResponse<StartBrowserResponseData>>(
        endpoint,
        { params }
      );
      console.log(
        'AdsPower start browser API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      const axiosError = error as AxiosError;
      console.error(
        `Error starting AdsPower browser for profile ID: ${userId}. Message: ${axiosError.message}`
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (startBrowser):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (startBrowser). Request details:',
          axiosError.request
        );
      } else {
  ...
  public async stopBrowser(
    userId: string
  ): Promise<AdsPowerResponse<StopBrowserResponseData> | null> {
    const endpoint = '/api/v1/browser/stop';
    const params = { user_id: userId };
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(
        `Attempting to stop AdsPower browser for profile ID: ${userId} at URL: ${fullUrl}`
      );
      const response = await this.apiClient.get<AdsPowerResponse<StopBrowserResponseData>>(
        endpoint,
        { params }
      );
      console.log(
        'AdsPower stop browser API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      const axiosError = error as AxiosError;
      console.error(
        `Error stopping AdsPower browser for profile ID: ${userId}. Message: ${axiosError.message}`
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (stopBrowser):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (stopBrowser). Request details:',
          axiosError.request
        );
      } else {
   ...
   */
  public async checkBrowserStatus(
    userId: string
  ): Promise<AdsPowerResponse<BrowserStatusResponseData> | null> {
    const endpoint = '/api/v1/browser/active';
    const params = { user_id: userId };
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(
        `Attempting to check AdsPower browser status for profile ID: ${userId} at URL: ${fullUrl}`
      );
      const response = await this.apiClient.get<AdsPowerResponse<BrowserStatusResponseData>>(
        endpoint,
        { params }
      );
      console.log(
        'AdsPower check browser status API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (checkBrowserStatus):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (checkBrowserStatus). Request details:',
          axiosError.request
        );
      } else {
        console.error(
          'Error setting up AdsPower API request (checkBrowserStatus):',
          axiosError.message
        );
      }
      return null;
  ...
  ): Promise<AdsPowerResponse<CreateGroupResponseData> | null> {
    const endpoint = '/api/v1/group/create';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to create AdsPower group at URL: ${fullUrl}`);
      console.log(
        'Attempting to create AdsPower group with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<CreateGroupResponseData>>(
        endpoint,
        payload
      );
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<CreateGroupResponseData>(response);
      }
      console.log(
        'AdsPower create group API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error: unknown) {
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while creating AdsPower group')
      );
    }
  }
  ...
  public async listGroups(
    page?: number,
    pageSize?: number
  ): Promise<AdsPowerResponse<AdsPowerGroupListData> | null> {
    ...
    try {
      ...
      const response = await this.apiClient.get<AdsPowerResponse<AdsPowerGroupListData>>(endpoint, {
        params,
      });
      console.log(
        'AdsPower list groups API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error) {
      ...
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (listGroups):',
          axiosError.response.status
        );
        console.error(
        ...
        console.error(
          'AdsPower API no response received (listGroups). Request details:',
          axiosError.request
        );
      } else {
  ...
  ): Promise<AdsPowerResponse<UpdateGroupResponseData> | null> {
    const endpoint = '/api/v1/group/update';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to update AdsPower group at URL: ${fullUrl}`);
      console.log(
        'Attempting to update AdsPower group with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<UpdateGroupResponseData>>(
        endpoint,
        payload
      );
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<UpdateGroupResponseData>(response);
      }
      console.log(
        'AdsPower update group API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error: unknown) {
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while updating AdsPower group')
      );
    }
  }  /**   
  ...
  public async deleteGroups(
    payload: DeleteGroupsPayload
  ): Promise<AdsPowerResponse<DeleteGroupsResponseData>> {
    const endpoint = '/api/v1/group/delete';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to delete AdsPower groups at URL: ${fullUrl}`);
      console.log(
        'Attempting to delete AdsPower groups with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<DeleteGroupsResponseData>>(
        endpoint,
        payload
      );
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<DeleteGroupsResponseData>(response);
      }
      console.log(
        'AdsPower delete groups API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error: unknown) {
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while deleting AdsPower groups')
      );
    }
  }
  ...
  public async getProfileDetail(
    userId: string
  ): Promise<AdsPowerResponse<AdsPowerProfileDetailData> | null> {
    ...
    try {
      ...
      if (
        ...
        if (response.data.data.list.length > 0) {
          ...
          console.log(
            `AdsPower profile with ID '${userId}' not found via /api/v1/user/list (empty list).`
          );
          return {
      ...
      const axiosError = error as AxiosError;
      console.error(
        `Error getting AdsPower profile detail for ID: ${userId}. Message: ${axiosError.message}`
      );
      if (axiosError.response) {
        console.error(
          'AdsPower API error response status (getProfileDetail):',
          axiosError.response.status
        );
        console.error(
  ...
  public async getGroupList(
    payload: GetGroupListPayload
  ): Promise<AdsPowerResponse<GetGroupListResponseData>> {
    const endpoint = '/api/v1/group/list';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to get AdsPower group list at URL: ${fullUrl}`);
      console.log(
        'Attempting to get AdsPower group list with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<GetGroupListResponseData>>(
        endpoint,
        payload
      );
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<GetGroupListResponseData>(response);
      }
      console.log('AdsPower group list API response data:', JSON.stringify(response.data, null, 2));
      return response.data;
    } catch (error: unknown) {
      if (error instanceof Error) {
        return this.handleErrorResponse(error);
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while getting AdsPower group list')
      );
    }
  }
  ...
  ): Promise<AdsPowerResponse<GetGroupInfoResponseData>> {
    const endpoint = '/api/v1/group/info';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to get AdsPower group info at URL: ${fullUrl}`);
      console.log(
        'Attempting to get AdsPower group info with payload:',
        JSON.stringify(payload, null, 2)
      );
      const response = await this.apiClient.post<AdsPowerResponse<GetGroupInfoResponseData>>(
        endpoint,
        payload
      );
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<GetGroupInfoResponseData>(response);
      }
      console.log('AdsPower group info API response data:', JSON.stringify(response.data, null, 2));
      return response.data;
    } catch (error: unknown) {
      if (error instanceof Error) {
        return this.handleErrorResponse(error);
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while getting AdsPower group info')
      );
    }
  }

  public async clearCache(): Promise<AdsPowerResponse<null>> {
    const endpoint = '/api/v1/browser/clear-cache';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to clear AdsPower browser cache at URL: ${fullUrl}`);
      const response = await this.apiClient.post<AdsPowerResponse<null>>(endpoint);
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<null>(response);
      }
      console.log(
        'AdsPower clear cache API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error: unknown) {
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while clearing AdsPower browser cache')
      );
    }
  }

  public async closeAllBrowsers(): Promise<AdsPowerResponse<null>> {
    const endpoint = '/api/v1/browser/stop-all';
    const fullUrl = `${this.apiClient.defaults.baseURL}${endpoint}`;
    try {
      console.log(`Attempting to close all AdsPower browsers at URL: ${fullUrl}`);
      const response = await this.apiClient.post<AdsPowerResponse<null>>(endpoint);
      if (response.data.code !== 0) {
        return this.handleUnexpectedResponse<null>(response);
      }
      console.log(
        'AdsPower close all browsers API response data:',
        JSON.stringify(response.data, null, 2)
      );
      return response.data;
    } catch (error: unknown) {
      ...
      return this.handleErrorResponse(
        new Error('Unknown error occurred while closing all AdsPower browsers')
      );
    }
  }
  ...
  private handleError(error: unknown): never {
    if (error instanceof Error) {
      console.error('AdsPower API error:', error.message);
      throw new Error(error.message);
    }
    console.error('Unknown error in AdsPower service:', error);
    throw new Error('Unknown error occurred in AdsPower service');
  }
  ...
  private async handleErrorResponse(error: Error): Promise<AdsPowerResponse<any>> {
    console.error('AdsPower API error:', error.message);
    return {
      code: -1,
      msg: error.message,
  ...
  private async handleUnexpectedResponse<T>(
    response: AxiosResponse<unknown>
  ): Promise<AdsPowerResponse<T>> {
    console.error('Unexpected AdsPower API response:', response.data);
    return {
      code: -1,
