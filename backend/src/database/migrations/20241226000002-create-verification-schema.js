...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('verification_products', {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true
    ...
    await queryInterface.createTable('verification_financial_discrepancies', {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true
    ...
    await queryInterface.createTable('verification_supplier_reports', {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true
    ...
    await queryInterface.createTable('verification_session_summary', {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true
    ...
    await queryInterface.addIndex('verification_sessions', ['delivery_file_id']);
    await queryInterface.addIndex('verification_sessions', ['supplier_id']);
    await queryInterface.addIndex('verification_sessions', ['verification_status']);
    await queryInterface.addIndex('verification_sessions', ['started_at']);
    
    await queryInterface.addIndex('verification_products', ['session_id']);
    await queryInterface.addIndex('verification_products', ['source_product_id']);
    await queryInterface.addIndex('verification_products', ['asin']);
    await queryInterface.addIndex('verification_products', ['classification']);
    await queryInterface.addIndex('verification_products', ['destination']);
    await queryInterface.addIndex('verification_products', ['lpn_group']);
    
    await queryInterface.addIndex('verification_financial_discrepancies', ['session_id']);
    await queryInterface.addIndex('verification_financial_discrepancies', ['verification_product_id']);
    await queryInterface.addIndex('verification_financial_discrepancies', ['impact_type']);
    
    await queryInterface.addIndex('verification_supplier_reports', ['session_id']);
    await queryInterface.addIndex('verification_supplier_reports', ['supplier_id']);
    await queryInterface.addIndex('verification_supplier_reports', ['report_type']);
    
    await queryInterface.addIndex('verification_session_summary', ['session_id']);
  },

  down: async (queryInterface, Sequelize) => {
    // Usuń tabele w odwrotnej kolejności (ze względu na klucze obce)
    await queryInterface.dropTable('verification_session_summary');
    await queryInterface.dropTable('verification_supplier_reports');
    await queryInterface.dropTable('verification_financial_discrepancies');
    await queryInterface.dropTable('verification_products');
