...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('supplier_deliveries_raw', {
      id: {
    ...
    await queryInterface.createTable('supplier_delivery_finance', {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true
    ...
    await queryInterface.addColumn('supplier_deliveries', 'delivery_file_id', {
      type: Sequelize.INTEGER,
    ...
    await queryInterface.addColumn('supplier_deliveries', 'validation_status', {
    ...
    await queryInterface.addColumn('supplier_deliveries', 'missing_fields', {
    ...
    await queryInterface.addIndex('supplier_deliveries_raw', ['supplier_id']);
    await queryInterface.addIndex('supplier_deliveries_raw', ['file_hash']);
    await queryInterface.addIndex('supplier_deliveries_raw', ['processing_status']);
    await queryInterface.addIndex('supplier_deliveries_raw', ['upload_timestamp']);
    
    await queryInterface.addIndex('supplier_delivery_finance', ['delivery_file_id']);
    await queryInterface.addIndex('supplier_delivery_finance', ['supplier_id']);
    
    await queryInterface.addIndex('supplier_deliveries', ['delivery_file_id']);
    await queryInterface.addIndex('supplier_deliveries', ['validation_status']);
  },

  down: async (queryInterface, Sequelize) => {
    // Usuń dodane kolumny z supplier_deliveries
    await queryInterface.removeColumn('supplier_deliveries', 'missing_fields');
    await queryInterface.removeColumn('supplier_deliveries', 'validation_status');
    await queryInterface.removeColumn('supplier_deliveries', 'delivery_file_id');
    
    // Usuń tabele
    await queryInterface.dropTable('supplier_delivery_finance');
    await queryInterface.dropTable('supplier_deliveries_raw');
  }
}; 