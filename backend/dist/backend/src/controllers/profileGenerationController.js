...
class ProfileGenerationController {
    constructor() {
        this.prepareBatch = (0, express_async_handler_1.default)((_req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // 2. Wygeneruj profile
                const preparedProfiles = yield profileGenerationService_1.profileGenerationService.prepareProfilesForAdsPower(targetZone);
                res.status(200).json({
                    success: true,
