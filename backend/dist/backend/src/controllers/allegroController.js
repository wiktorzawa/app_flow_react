...
class AllegroController {
    constructor() {
        ...
        this.handleCallback = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            if (!req.session) {
        ...
        this.searchOffersByEAN = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
