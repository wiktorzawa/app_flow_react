...
class AdsPowerService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (createProfile):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (createProfile):", JSON.stringify(axiosError.response.data, null, 2));
                }
     ...
     */
    listProfiles() {
        return __awaiter(this, arguments, void 0, function* (page = 1, pageSize = 50 // AdsPower API często ma domyślny limit, np. 50 lub 100
        ) {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (listProfiles):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (listProfiles):", JSON.stringify(axiosError.response.data, null, 2));
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (updateProfile):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (updateProfile):", JSON.stringify(axiosError.response.data, null, 2));
                    // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (deleteProfiles):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (deleteProfiles):", JSON.stringify(axiosError.response.data, null, 2));
                    // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (regroupProfiles):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (regroupProfiles):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (clearAllProfilesCache):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (clearAllProfilesCache):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
                    console.error("AdsPower API no response received (clearAllProfilesCache). Request details:", axiosError.request);
                }
                else {
     ...
     */
    startBrowser(userId, launchArgs, // Dodatkowe argumenty uruchamiania przeglądarki
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (startBrowser):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (startBrowser):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (stopBrowser):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (stopBrowser):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (checkBrowserStatus):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (checkBrowserStatus):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (createGroup):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (createGroup):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (listGroups):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (listGroups):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (updateGroup):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (updateGroup):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (deleteGroups):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (deleteGroups):", JSON.stringify(axiosError.response.data, null, 2));
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
    ...
    getProfileDetail(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(`AdsPower get profile detail (via list) API response data for ID ${userId}:`, JSON.stringify(response.data, null, 2));
                ...
                if (response.data && response.data.code === 0 && response.data.data && response.data.data.list) {
                    ...
                    console.error(`AdsPower API returned an unexpected response structure or error code for profile detail ID '${userId}':`, response.data);
                ...
                if (axiosError.response) {
                    ...
                    console.error("AdsPower API error response headers (getProfileDetail):", JSON.stringify(axiosError.response.headers, null, 2));
                    console.error("AdsPower API error response data (getProfileDetail):", JSON.stringify(axiosError.response.data, null, 2));
                    // Zwróć dane błędu z odpowiedzi AdsPower, jeśli są dostępne
                    return axiosError.response.data;
                }
                else if (axiosError.request) {
                    console.error(`AdsPower API no response received (getProfileDetail for ID: ${userId}). Request details:`, axiosError.request);
                }
                else {
