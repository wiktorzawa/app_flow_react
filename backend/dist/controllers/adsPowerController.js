...
const UserProxyConfigSchema = zod_1.z
    ...
    message: "proxy_host, proxy_port, and proxy_type are required when proxy_soft is not 'no_proxy' or an 'auto' type that handles it.",
...
const CreateProfilePayloadSchema = zod_1.z
    ...
    country: zod_1.z.string().refine(countryValidation_1.isValidCountry, { message: "Invalid country code." }).optional(),
    region: zod_1.z.string().optional(),
    city: zod_1.z.string().optional(),
    ipchecker: zod_1.z.enum(["ip2location", "ipapi"]).optional(),
    sys_app_cate_id: zod_1.z.string().optional(),
    repeat_config: zod_1.z.array(zod_1.z.union([zod_1.z.literal(0), zod_1.z.literal(2), zod_1.z.literal(3), zod_1.z.literal(4)])).optional(),
})
    .strict();
...
const DeleteProfilesBodySchema = zod_1.z
    .object({
    user_ids: zod_1.z.array(zod_1.z.string().min(1, "User ID in array cannot be empty")).min(1, "user_ids array cannot be empty"),
})
    .strict();
...
class AdsPowerController {
    constructor() {
         ...
         */
        this.checkAdsPowerApi = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 503 : 500).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to connect to AdsPower API or API returned an error.",
                    errorDetails: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.data) || null,
                });
            }
        }));
        /**
         ...
         */
        this.handleCreateProfile = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0 && apiResponse.data && apiResponse.data.id) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to create AdsPower profile or API returned an error.",
         ...
         */
        this.listAdsPowerProfiles = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 503 : 500).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to list AdsPower profiles or API returned an error.",
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.updateAdsPowerProfile = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to update AdsPower profile ${userId} or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.deleteAdsPowerProfiles = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                console.error(`AdsPower API returned an error during profile deletion for user_ids: ${payload.user_ids.join(", ")}:`, apiResponse);
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to delete AdsPower profiles or API returned an error.",
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.regroupAdsPowerProfiles = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                console.error(`AdsPower API returned an error during profile regrouping for user_ids: ${payload.user_ids.join(", ")} to group_id: ${payload.group_id}:`, apiResponse);
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to regroup AdsPower profiles or API returned an error.",
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.clearAllAdsPowerProfilesCache = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                const statusCode = (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 ? 409 : (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) !== 0 && apiResponse !== null ? 400 : 500;
                ...
                res.status(statusCode).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to clear all AdsPower profiles cache or API returned an error.",
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.startAdsPowerBrowser = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
            if (!paramsValidationResult.success) {
                res.status(400).json({
                    success: false,
            ...
            const apiResponse = yield adsPowerService_1.default.startBrowser(userId, launch_args, ip_tab, open_tabs, clear_cache_after_closing);
            if (apiResponse && apiResponse.code === 0 && apiResponse.data && apiResponse.data.ws) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to start AdsPower browser for profile ${userId} or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.stopAdsPowerBrowser = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
            if (!paramsValidationResult.success) {
                res.status(400).json({
                    success: false,
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to stop AdsPower browser for profile ${userId} or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.checkAdsPowerBrowserStatus = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
            if (!paramsValidationResult.success) {
                res.status(400).json({
                    success: false,
            ...
            if (apiResponse && apiResponse.code === 0 && apiResponse.data && apiResponse.data.status) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to check AdsPower browser status for profile ${userId} or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.createAdsPowerGroup = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
         ...
         */
        this.listAdsPowerGroups = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0 && apiResponse.data) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || "Failed to list AdsPower groups or API returned an error.",
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.updateAdsPowerGroup = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to update AdsPower group ID '${payload.group_id}' or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.deleteAdsPowerGroups = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (apiResponse && apiResponse.code === 0) {
                ...
                console.error(`AdsPower API returned an error during group deletion for IDs '${payload.group_ids.join(", ")}':`, apiResponse);
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to delete AdsPower groups or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
         ...
         */
        this.getAdsPowerProfileDetail = (0, express_async_handler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const paramsValidationResult = UserIdParamSchema.safeParse(req.params);
            if (!paramsValidationResult.success) {
                res.status(400).json({
                    success: false,
            ...
            if (apiResponse && apiResponse.code === 0 && apiResponse.data) {
                ...
                res.status((apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse ? 500 : 400).json({
                    success: false,
                    message: (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.msg) || `Failed to retrieve profile detail for ID '${userId}' or API returned an error.`,
                    errorDetails: apiResponse || null,
                });
            }
        }));
