...
const CreateProfilePayloadSchema = zod_1.z
  .object({
    ...
    repeat_config: zod_1.z
      .array(zod_1.z.union([zod_1.z.literal(0), zod_1.z.literal(2), zod_1.z.literal(3), zod_1.z.literal(4)]))
      .optional(),
  })
  .strict();
    ...
    this.checkAdsPowerApi = (0, express_async_handler_1.default)((req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (apiResponse && apiResponse.code === 0) {
          ...
          res
            .status(
              (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1 || !apiResponse
                ? 503
                : 500
            )
            .json({
        ...
        if (apiResponse && apiResponse.code === 0) {
          ...
          const statusCode =
            (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) === -1
              ? 409
              : (apiResponse === null || apiResponse === void 0 ? void 0 : apiResponse.code) !== 0 &&
                  apiResponse !== null
                ? 400
                : 500;
