...
class RequestManager {
    ...
    executeWithRetry(action_1) {
        return __awaiter(this, arguments, void 0, function* (action, options = {}) {
            ...
            throw new Error(`Failed after ${finalOptions.maxRetries} attempts. Last error: ${lastError === null || lastError === void 0 ? void 0 : lastError.message}`);
        });
    }
    navigateToUrl(url, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.executeWithRetry(() => __awaiter(this, void 0, void 0, function* () {
                yield this.page.goto(url, {
                    timeout: (options === null || options === void 0 ? void 0 : options.timeout) || this.defaultOptions.timeout,
