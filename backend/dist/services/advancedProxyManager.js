    ...
    getProxyConfigByType(type) {
        ...
        switch (type) {
            case ProxyType.RESIDENTIAL:
                return Object.assign(Object.assign({}, baseConfig), { host: "zproxy.lum-superproxy.io", port: 22225, proxyType: ProxyType.RESIDENTIAL });
            case ProxyType.DATACENTER:
                return Object.assign(Object.assign({}, baseConfig), { host: "brd.superproxy.io", port: 22225, proxyType: ProxyType.DATACENTER });
            case ProxyType.ISP:
                return Object.assign(Object.assign({}, baseConfig), { host: "isp.lum-superproxy.io", port: 22225, proxyType: ProxyType.ISP });
            case ProxyType.MOBILE:
                return Object.assign(Object.assign({}, baseConfig), { host: "mobile.lum-superproxy.io", port: 22225, proxyType: ProxyType.MOBILE });
        }
    }
