...
exports.verifyPassword =
  exports.lockAccount =
  exports.resetFailedLoginAttempts =
  exports.incrementFailedLoginAttempts =
  exports.updateLastLogin =
  exports.getAuthDataById =
  exports.getAuthDataByEmail =
    void 0;
 ...
 */
const getAuthDataByEmail = (email) =>
 ...
 * @returns Dane uwierzytelniania lub null, jeśli nie znaleziono
 */
const getAuthDataById = (id_login) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
 ...
 * @param id_login Identyfikator logowania
 */
const updateLastLogin = (id_login) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
 ...
 */
const incrementFailedLoginAttempts = (id_login) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
      ...
      const [rows] = yield connection.query("SELECT failed_login_attempts FROM login_auth_data WHERE id_login = ?", [
        id_login,
      ]);
 ...
 * @param id_login Identyfikator logowania
 */
const resetFailedLoginAttempts = (id_login) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
      yield connection.execute(
 ...
 */
const lockAccount = (id_login, minutes) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
      yield connection.execute(
