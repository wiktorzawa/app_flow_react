    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (axiosError.response) {
          ...
          console.error(
            'Error setting up AdsPower API request (createProfile):',
            axiosError.message
          );
        }
      ...
      function* (
        ...
        try {
          ...
          if (axiosError.response) {
            ...
            console.error(
              'Error setting up AdsPower API request (listProfiles):',
              axiosError.message
            );
          }
  ...
  updateProfile(payload) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          'Request payload for failed profile update:',
          JSON.stringify(payload, null, 2)
        );
        if (axiosError.response) {
          console.error(
          ...
          console.error(
            'Error setting up AdsPower API request (updateProfile):',
            axiosError.message
          );
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (axiosError.response) {
          ...
          console.error(
            'Error setting up AdsPower API request (startBrowser):',
            axiosError.message
          );
        }
        return null;
  ...
  createGroup(payload) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          'Request payload for failed group creation:',
          JSON.stringify(payload, null, 2)
        );
        if (axiosError.response) {
          console.error(
            'AdsPower API error response status (createGroup):',
            axiosError.response.status
          );
          console.error(
          ...
          console.error(
            'AdsPower API no response received (createGroup). Request details:',
            axiosError.request
          );
        } else {
  ...
  updateGroup(payload) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const axiosError = error;
        console.error(
          `Error updating AdsPower group (ID: ${payload.group_id}). Message: ${axiosError.message}`
        );
        console.error('Request payload for failed group update:', JSON.stringify(payload, null, 2));
        if (axiosError.response) {
          console.error(
            'AdsPower API error response status (updateGroup):',
            axiosError.response.status
          );
          console.error(
          ...
          console.error(
            'AdsPower API no response received (updateGroup). Request details:',
            axiosError.request
          );
        } else {
  ...
  deleteGroups(payload) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          'Request payload for failed group deletion:',
          JSON.stringify(payload, null, 2)
        );
        if (axiosError.response) {
          console.error(
            'AdsPower API error response status (deleteGroups):',
            axiosError.response.status
          );
          console.error(
          ...
          console.error(
            'AdsPower API no response received (deleteGroups). Request details:',
            axiosError.request
          );
        } else {
          console.error(
            'Error setting up AdsPower API request (deleteGroups):',
            axiosError.message
          );
        }
        return null;
