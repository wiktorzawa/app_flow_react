...
class AllegroService {
  ...
  getBasicAuthHeader() {
    return Buffer.from(
      `${config_1.config.allegroClientId}:${config_1.config.allegroClientSecret}`
    ).toString('base64');
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          ...
          `URL: ${tokenUrl}`,
          (_a = axiosError.response) === null || _a === void 0 ? void 0 : _a.status,
          ((_b = axiosError.response) === null || _b === void 0 ? void 0 : _b.data) ||
            axiosError.message
        );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          ...
          ((_c = axiosError.response) === null || _c === void 0 ? void 0 : _c.data) ||
            axiosError.message
        );
  ...
  buildLoginUrl(state) {
    ...
    const loginUrl = new URL(
      `${config_1.config.allegroAuthTokenUrl.replace('/token', '')}/authorize`
    ); // Dostosowanie URL do autoryzacji
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        console.error(
          ...
          `URL: ${config_1.config.allegroAuthTokenUrl}`,
          (_a = axiosError.response) === null || _a === void 0 ? void 0 : _a.status,
          ((_b = axiosError.response) === null || _b === void 0 ? void 0 : _b.data) ||
            axiosError.message,
          `Request body: ${body}`
