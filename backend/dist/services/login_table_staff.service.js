...
const generateStaffId = (role) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const [rows] = yield connection.query("SELECT id_staff FROM login_table_staff WHERE id_staff LIKE ?", [
        `${prefix}%`,
      ]);
 ...
 */
const createStaffWithPassword = (staff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
 ...
 */
const updateStaff = (id_staff, staff) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const connection = yield db_1.default.getConnection();
    try {
      const updates = [];
