...
const deleteSupplier = (id_supplier) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      // Usuń dostawcę
      const [result] = yield connection.execute("DELETE FROM login_table_suppliers WHERE id_supplier = ?", [
        id_supplier,
      ]);
      yield connection.commit();
...
const generateSupplierId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const [rows] = yield connection.query("SELECT id_supplier FROM login_table_suppliers WHERE id_supplier LIKE ?", [
        `${prefix}%`,
      ]);
