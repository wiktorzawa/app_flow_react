    ...
    function svgMapWrapper(i) {
      ...
      return a.prototype.init = function(l) {
        this.options = Object.assign({}, { targetElementID: "", minZoom: 1, maxZoom: 25, initialZoom: 1.06, initialPan: { x: 0, y: 0 }, zoomScaleSensitivity: 0.2, mouseWheelZoomEnabled: true, mouseWheelZoomWithKey: false, mouseWheelKeyMessage: "Press the [ALT] key to zoom", mouseWheelKeyMessageMac: "Press the [COMMAND] key to zoom", colorMax: "#CC0033", colorMin: "#FFE5D9", colorNoData: "#E2E2E2", manualColorAttribute: "color", flagType: "image", flagURL: "https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/{0}.svg", hideFlag: false, hideMissingData: false, noDataText: "No data available", touchLink: false, showZoomReset: false, onGetTooltip: function(l2, t, e) {
          return null;
        }, countries: { EH: true }, showContinentSelector: false }, l || {}), this.options.targetElementID && document.getElementById(this.options.targetElementID) || this.error("Target element not found"), this.options.data || this.error("No data"), this.id = this.options.targetElementID, this.wrapper = document.getElementById(this.options.targetElementID), this.wrapper.classList.add("svgMap-wrapper"), this.container = document.createElement("div"), this.container.classList.add("svgMap-container"), this.wrapper.appendChild(this.container), this.options.mouseWheelZoomEnabled && this.options.mouseWheelZoomWithKey && (this.addMouseWheelZoomNotice(), this.addMouseWheelZoomWithKeyEvents()), this.mapContainer = document.createElement("div"), this.mapContainer.classList.add("svgMap-map-container"), this.container.appendChild(this.mapContainer), this.createMap(), this.applyData(this.options.data);
        ...
        Object.keys(o.values).forEach(function(l) {
          ...
          e && (o.values[l] ? void 0 === o.values[l].color ? (t = Math.max(a2, parseInt(o.values[l][o.applyData], 10)), t = Math.max(0, Math.min(1, (t - a2) / (i2 - a2))), t = this.getColor(this.toHex(this.options.colorMax), this.toHex(this.options.colorMin), t || 0 === t ? t : 1), e.setAttribute("fill", t)) : e.setAttribute("fill", o.values[l].color) : e.setAttribute("fill", this.toHex(this.options.colorNoData)));
        }).bind(this));
        ...
        this.options.countries.EH || (t.MA.d = t["MA-EH"].d, delete t.EH), delete t["MA-EH"], this.tooltipMoveEvent = (function(l2) {
          this.moveTooltip(l2);
      ...
      }, a.prototype.toHex = function(l, t = document.documentElement) {
        var e;
        l.startsWith("var(") && (e = l.slice(4, -1).trim().replaceAll(/["']+/g, ""), l = getComputedStyle(t).getPropertyValue(e).trim());
        const o = new OffscreenCanvas(1, 1), i2 = o.getContext("2d");
        return i2.fillStyle = l, i2.fillStyle;
