...
import {
  ...
  HiSun,
  HiX
} from "./chunk-IZAGW65C.js";
import "./chunk-BFWBVO2Z.js";
import {
  require_react
...
var Badge = ({ children, color = "info", href, icon: Icon, size: size4 = "xs", className, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.badge, customTheme);
  const Content = () => (0, import_jsx_runtime9.jsxs)("span", { className: twMerge(theme2.root.base, theme2.root.color[color], theme2.icon[Icon ? "on" : "off"], theme2.root.size[size4], className), "data-testid": "flowbite-badge", ...props, children: [Icon && (0, import_jsx_runtime9.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size4], "data-testid": "flowbite-badge-icon" }), children && (0, import_jsx_runtime9.jsx)("span", { children })] });
          ...
          if (prevIndex === -1) {
            ...
            if (loop && (prevIndex - cols < minIndex || indexRef.current < 0)) {
              ...
              if (maxCol === col) {
                ...
                indexRef.current = maxCol > col ? offset4 : offset4 - cols;
              }
            }
          }
...
var Trigger = ({ refs, children, inline: inline4, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline4 ? (0, import_jsx_runtime22.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime22.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react26.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size4 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  const { size: size4 = "sm" } = useRatingContext();
  const theme2 = mergeDeep(useTheme().theme.rating.star, customTheme);
  return (0, import_jsx_runtime52.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size4], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size4 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsx)(RatingContext.Provider, { value: { size: size4 }, children: (0, import_jsx_runtime53.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Tooltip = ({ animation = "duration-300", arrow: arrow4 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime84.jsx)(Floating, { animation, arrow: arrow4, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
