...
const EcommerceBillingPage: FC = function () {
  return (
    <NavbarSidebarLayout>
      <div className="mb-6 grid grid-cols-1 gap-y-6 px-4 pt-6 xl:grid-cols-2 xl:gap-4 dark:border-gray-700 dark:bg-gray-900">
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow className="bg-gray-50 dark:bg-gray-700">
                    <TableCell className="rounded-l-lg p-4 text-sm font-normal whitespace-nowrap text-gray-900 dark:text-white">
                      Payment refund to&nbsp;
                    ...
                    <TableCell className="flex rounded-r-lg p-4 whitespace-nowrap">
                      <Badge color="success">Completed</Badge>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="p-4 pb-0 text-sm font-normal whitespace-nowrap text-gray-900 dark:text-white">
                      Payment failed from&nbsp;
                      <span className="font-semibold">#087651</span>
                    </TableCell>
                    <TableCell className="p-4 pb-0 text-sm font-normal whitespace-nowrap text-gray-500 dark:text-gray-400">
                      Apr 18, 2021
                    </TableCell>
                    <TableCell className="p-4 pb-0 text-sm font-semibold whitespace-nowrap text-gray-900 dark:text-white">
                      $234
                    </TableCell>
                    <TableCell className="flex p-4 pb-0 whitespace-nowrap">
