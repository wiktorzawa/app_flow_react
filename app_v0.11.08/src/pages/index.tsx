...
// Usunięte problematyczne importy - zastąpione prostymi implementacjami
// import Chart from "react-apexcharts";
// import svgMap from "svgmap";
// import "svgmap/dist/svgMap.min.css"; // Usunięte ze względu na problemy z zależnościami
...
const SalesChart: FC = function () {
  // Sprawdzenie dark mode z localStorage lub system preference
  ...
  return (
    <div className="flex h-64 items-center justify-center rounded-lg bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400">
      Chart Placeholder
    </div>
  );
};
      ...
      <ul className="space-y-6">
        <li className="w-full items-center sm:flex">
          ...
          <div className="h-5 w-full rounded-lg bg-gray-200 dark:bg-gray-700">
            <div
              className="bg-primary-700 text-primary-100 h-5 rounded-md p-1 text-center text-xs leading-none font-bold"
              style={{ width: "35%" }}
            >
              {" "}
              35%
...
const SessionsByCountryMap: FC = function () {
  ...
  useEffect(() => {
    // Placeholder dla svgMap - usunięte ze względu na problemy z zależnościami
    const mapContainer = document.getElementById("map");
    if (mapContainer) {
      mapContainer.innerHTML =
        '<div class="h-64 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center text-gray-500 dark:text-gray-400">World Map Placeholder</div>';
    }
  }, [isDarkTheme]);
          ...
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden shadow sm:rounded-lg">
              <Table className="min-w-full table-fixed">
                <TableHead>
                  <TableHeadCell className="rounded-l border-x-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold whitespace-nowrap text-gray-700 uppercase dark:bg-gray-700 dark:text-white">
                    Top Channels
                  </TableHeadCell>
                  <TableHeadCell className="border-x-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold whitespace-nowrap text-gray-700 uppercase dark:bg-gray-700 dark:text-white">
                    Users
                  </TableHeadCell>
                  <TableHeadCell className="min-w-[140px] rounded-r border-x-0 bg-gray-50 px-4 py-3 text-left align-middle text-xs font-semibold whitespace-nowrap text-gray-700 uppercase dark:bg-gray-700 dark:text-white">
                    Acquisition
                  </TableHeadCell>
                </TableHead>
                <TableBody className="divide-y divide-gray-100 dark:divide-gray-700">
                  <TableRow className="text-gray-500 dark:text-gray-400">
                    <TableCell className="border-t-0 p-4 text-left align-middle text-sm font-normal whitespace-nowrap">
                      Organic Search
                    </TableCell>
                    <TableCell className="border-t-0 p-4 align-middle text-xs font-medium whitespace-nowrap text-gray-900 dark:text-white">
                      5,649
                    </TableCell>
                    <TableCell className="border-t-0 p-4 align-middle text-xs whitespace-nowrap">
                      <div className="flex items-center">
