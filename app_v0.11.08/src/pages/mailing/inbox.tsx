            ...
            <Table className="min-w-full divide-y divide-gray-200">
              <TableBody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                <TableRow className="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
                  ...
                  <TableCell className="max-w-sm truncate overflow-hidden p-4 text-base font-semibold text-gray-900 xl:max-w-screen-md 2xl:max-w-screen-lg dark:text-white">
                ...
                <TableRow className="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-600">
                  ...
                  <TableCell className="max-w-sm truncate overflow-hidden p-4 text-base font-normal text-gray-700 xl:max-w-screen-md 2xl:max-w-screen-lg dark:text-gray-400">
                  ...
                  <TableCell className="p-4 text-base font-normal whitespace-nowrap text-gray-700 dark:text-gray-400">
