...
const ProfileLockPage = lazy(
  () => import("./pages/authentication/profile-lock"),
);
...
const AdsPowerDashboardPage = lazy(
  () => import("./pages/admin/AdsPowerDashboardPage"),
);
const DatabaseViewer = lazy(() => import("./pages/DatabaseViewer"));
const CryptoExchangePage = lazy(
  () => import("./pages/financial/crypto-exchange"),
);
        ...
        <Routes>
          <Route element={<FlowbiteWrapper />}>
            ...
            <Route
              ...
              element={<ProtectedRoute element={<MailingComposePage />} />}
            />
            <Route
              path="/mailing/inbox"
              element={<ProtectedRoute element={<MailingInboxPage />} />}
            />
            <Route
              path="/mailing/read"
              element={<ProtectedRoute element={<MailingReadPage />} />}
            />
            <Route
              path="/mailing/reply"
              element={<ProtectedRoute element={<MailingReplyPage />} />}
            />
            <Route
              path="/kanban"
            ...
            <Route
              path="/pages/pricing"
              element={<ProtectedRoute element={<PricingPage />} />}
            />
            <Route
              path="/pages/maintenance"
              element={<ProtectedRoute element={<MaintenancePage />} />}
            />
            ...
            <Route
              ...
              element={<ProtectedRoute element={<EcommerceBillingPage />} />}
            />
            <Route
              path="/e-commerce/invoice"
              element={<ProtectedRoute element={<EcommerceInvoicePage />} />}
            />
            <Route
              path="/e-commerce/products"
              element={<ProtectedRoute element={<EcommerceProductsPage />} />}
            />

            <Route
              path="/financial/crypto-exchange"
              element={<ProtectedRoute element={<CryptoExchangePage />} />}
            />
